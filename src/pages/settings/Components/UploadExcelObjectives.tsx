...
const UploadExcelObjectives: FunctionComponent<{ data: Function }> = ({
  data,
}) => {
  ...
  const upload = async () => {
    ...
    setLoading(true);
    //upload Excel
    const responseUpload = await CRMRepository.uploadExcelObjectives({
      file: fileExcel[0],
    ...
    const respObjectives: Objectives[] | [] =
  ...
  return (
    <div style={{ position: 'relative' }}>
      <Link to="/excel/Template_ventas_excel.xlsx" target="_blank">
...
export default UploadExcelObjectives;
