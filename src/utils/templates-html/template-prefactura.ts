...
import { calcTotalQuotesGenerated, currenyFormat } from '../extras';
...
export const templatePrefactura = ({
  client,
  lead,
  descuento,
  payThirdPerson,
  ...
  <tbody>
    ...
    <tr style=" border: 1px solid rgb(179 177 177); ">
      <td colspan="2" style=" padding: 0.5rem; ">
        ...
        <br />
        <b>Tipo de Cliente: </b>
        ${lead.inquiry?.find((inq) => inq!.question === 'clientType')?.answer === 'retail'
      ? 'RETAIL'
      : 'FLOTA'
    }
      </td>
...
`;
  ...
  const vehiculosComprados = () => {
    return ` ${vehiclesToShow.map((vhToShow: any, index) => {
      ...
      return tablaVehiculosComprados({ vhToShow, index, gradeRender })
    })}`
  }

  const tablaVehiculosComprados = ({ vhToShow, index, gradeRender }: { vhToShow: any, index: number, gradeRender: any }) => {
    return `
              ...
              <th colspan="2">
                ...
                >
                  ...
                  <span
                    ...
                    style=" font-size: 40px; color: rgb(230, 230, 230); "
                  >
                    <svg
  ...
  const listaAccesorios = ({ accesories }: { accesories: [] }) => {
    return accesories.map((acc: any, index: number) => (
      `
       <tr>
       <td
         style="
      ...
      <table
        ...
        `<tbody>
            <tr>
              ...
              <th style=" text-align: center; ">Subtotal</th>
              <th style=" text-align: center; ">IVA</th>
              <th style=" text-align: center; min-width: 200; ">Total</th>
            </tr>
  ...
  const formaPago = ({
    ...
    return (
      ...
      currenyFormat(vhToShow.inputAmount ?? 0, true)}
        ...
        `<tbody>
              <tr>
                <td style=" border-bottom: none; ">SEGURO</td>
              ...
              <tr>
                <td style=" border-bottom: none; ">MATRÍCULA</td>
                <td style=" border-bottom: none; ">
        ...
        <tr>
          ...
          >
            <div style=" display: flex; flex-direction: column; ">
              ...
              <hr style=" margin: 0; margin-block-start: 0; " />
              <div
                style="
                  display: flex;
                  flex-direction: row;
        ...
        totalSummaryValues.totalValuesAccesories * 1.12
          ...
          >
            ...
            >
              ...
              <div style=" padding: 0.5rem; ">
                <h3>Comentarios</h3>
                <span style=" font-size: 0.75rem; ">${notesRender()}</span>
              </div>
  ...
  const template = `
  <div style=" margin: 4rem; padding-bottom: 4rem; ">
